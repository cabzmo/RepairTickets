...
public class ClosedStatusDataManager implements DataManager {

    private final String RESOURCE = "./resources/data/statusClosed.txt";
        ...
        try (Scanner sc = new Scanner(new File(RESOURCE))) {
            ...
            while (sc.hasNextLine()) {
                ...
                try {
                    ...
                    ClosedStatus status = new ClosedStatus(id, central.getPersonByID(personID));
                    central.addClosedStatus(status);
    ...
    public void storeData(Central central) throws IOException {
        try (PrintWriter out = new PrintWriter(new FileWriter(RESOURCE))) {
            for (ClosedStatus status : central.getClosedStatuses()) {
